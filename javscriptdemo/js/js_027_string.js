...
function display(person) {
    ...
    console.log(`연락처 : ${person.phone}`);
    let a = person.phone.indexOf('-');
    let b = person.phone.indexOf('-', a + 1);
    console.log(`${a}`);
    console.log(`${b}`);
    let c = person.phone.substring(a + 1, b);
    console.log(person.phone.replace(c, '*'));
}
///////////
let person1 = { name: '홍길동', phone: '010-1234-5678' };
